...
include "config/connect.php"; // 3. เชื่อมต่อฐานข้อมูล
...
// --- ตรวจสอบ Session หลังจากตั้งค่าเรียบร้อยแล้ว ---
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <?php
                ...
                if ($lesson_result && $lesson_result->num_rows > 0) {
                    ...
                    echo '<li><a class="dropdown-item" href="#">บทที่1</a></li>';
                    echo '<li><a class="dropdown-item" href="#">บทที่2</a></li>';
                }
              ?>
            </ul>
          </li>
          ...
          <div class="row g-2">
            <div class="col-sm-8">
              <form class="input-group" method="get" action="index.php">
                <input type="hidden" name="page" value="plane">
                <span class="input-group-text bg-white"><i class="bi bi-search"></i></span>
                <input id="q" name="q" class="form-control"
                      placeholder="ค้นหาบทเรียน เช่น OSI, Subnet, Routing"
            ...
            <div class="col-sm-4 d-grid d-sm-block">
              <a href="index.php?page=plane" class="btn btn-success w-100"><i class="bi bi-list-check me-1"></i> ดูหัวข้อทั้งหมด</a>
            </div>
          </div>
        </div>
        <div class="col-lg-5">
...
<?php
if($page=="plane"){
    include "page/plane.php";
}elseif($page=="work"){
    include "page/work.php";
}elseif($page=="lessons"){
    include "page/lessons.php";
